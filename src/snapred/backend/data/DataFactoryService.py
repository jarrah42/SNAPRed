...
class DataFactoryService:
    ...
    @validate_call
    def getLatestCalibrationVersion(self, runId: str, useLiteMode: bool):
        return self.lookupService.calibrationIndexer(runId, useLiteMode).getLatestApplicableVersion(runId)
    ...
    def getLatestNormalizationVersion(self, runId: str, useLiteMode: bool):
        return self.lookupService.normalizationIndexer(runId, useLiteMode).getLatestApplicableVersion(runId)
