...
class LocalDataService:
    ...
    def readStateConfig(self, runId: str, useLiteMode: bool) -> StateConfig:
        diffCalibration = self.calibrationIndexer(runId, useLiteMode).readParameters(VersionState.LATEST)
    ...
    def normalizationExists(self, runId: str, useLiteMode: bool) -> bool:
        version = self.normalizationIndexer(runId, useLiteMode).getLatestApplicableVersion(runId)
        return version is not None

    @validate_call
    def readNormalizationRecord(self, runId: str, useLiteMode: bool, version: Optional[Version] = VersionState.LATEST):
        """
    ...
    def calibrationExists(self, runId: str, useLiteMode: bool) -> bool:
        version = self.calibrationIndexer(runId, useLiteMode).getLatestApplicableVersion(runId)
        return version is not None
