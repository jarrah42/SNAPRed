...
class TestNormalizationService(unittest.TestCase):
    ...
    def test_normalization(
        ...
        self.instance.dataFactoryService.getLatestCalibrationVersion = mock.Mock(return_value=1)
    ...
    def test_validateDiffractionCalibrationExists_failure(self):
        ...
        self.instance.sousChef = SculleryBoy()
        self.instance.dataFactoryService.getLatestCalibrationVersion = mock.Mock(return_value=None)
